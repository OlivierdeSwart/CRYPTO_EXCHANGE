...
contract Exchange {
	...
	function cancelOrder(uint256 _id) public{
		...
		//ensure caller of the function is the owner of the order
	...
	function fillOrder(uint256 _id) public {
		...
		require(_id > 0 && _id <= orderCount, 'order does not exit');
	...
	function _trade(
		...
		// Execute the trade
		// msg.sender is the user who filled the order while _user created the order
